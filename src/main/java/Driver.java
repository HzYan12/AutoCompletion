...
public class Driver {
	...
	public static void main(String[] args) throws ClassNotFoundException, IOException, InterruptedException {
		...
		conf1.set("textinputformat.record.delimiter", "."); // read one sentence by one sentence
		...
		DBConfiguration.configureDB(conf2, 
				...
				"jdbc:mysql://ip_address:port/test", // Need a update your mysql server
				"root",
				"password");
		...
		// Need a mysql connector or put it in the dependency
		...
		DBOutputFormat.setOutput(job2, "DatabaseOutput",
